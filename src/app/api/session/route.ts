      ...
      session: {
        ...
        audio: {
          input: {
            ...
            // English hint unless Hindi or Korean is chosen: without it, quiet audio was transcribed as Chinese.
            transcription: { model: "higgs-stt-3.1", language: language === "hi" || language === "ko" ? language : "en" },
            noise_reduction: null, // Chrome already suppresses noise; stacking Boson NR stripped real speech
          },
          output: {
            format: { type: "audio/pcm", rate: 24000 },
